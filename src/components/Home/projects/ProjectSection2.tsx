    ...
    <section id="projects" className="relative w-full overflow-hidden py-20">
      ...
      <div className="container mx-auto px-4">
              ...
              <div className="flex flex-col gap-8 lg:flex-row">
                ...
                <div className="group relative w-full overflow-hidden rounded-xl lg:w-1/2">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    <div className="absolute right-0 bottom-6 left-0 flex justify-center space-x-4">
                      ...
                      <Button
                        variant="outline"
                        className="flex items-center border-cyan-500 bg-black/70 px-4 py-2 text-sm font-medium text-white shadow-lg hover:scale-105 hover:bg-cyan-500 hover:text-white"
                        onClick={() =>
                          window.open(
                ...
                <div className="flex w-full flex-col justify-between p-6 lg:w-1/2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {projects[activeProject].stack.frontend.map(
                            (tech, index) => (
                              <span
                                key={index}
                                className="rounded-full bg-cyan-100 dark:bg-cyan-900 px-2 py-1 text-xs font-medium text-cyan-800 dark:text-cyan-200"
                              >
                                {tech}
                              </span>
                            ),
                        ...
                        <div className="flex flex-wrap gap-1">
                          {projects[activeProject].stack.backend.map(
                            (tech, index) => (
                              <span
                                key={index}
                                className="rounded-full bg-emerald-100 dark:bg-emerald-900 px-2 py-1 text-xs font-medium text-emerald-800 dark:text-emerald-200"
                              >
                                {tech}
                              </span>
                            ),
                  ...
                  <div className="mt-6 flex flex-col gap-3 sm:hidden">
                    ...
                    <Button
                      variant="outline"
                      className="flex w-full items-center justify-center border-cyan-500 py-3 font-medium text-cyan-500 hover:bg-cyan-500 hover:text-white"
                      onClick={() =>
          ...
          {projects.map((_, index) => (
            <button
              ...
              className={`h-2 w-2 rounded-full transition-all ${
                activeProject === index
                  ? "w-6 bg-gradient-to-r from-emerald-400 to-cyan-500"
        ...
        <div className="mt-16 flex justify-center">
          <Button
            variant="outline"
            className="group border-2 border-emerald-500 px-8 py-6 font-medium text-emerald-500 shadow-lg transition-all duration-300 hover:scale-105 hover:bg-emerald-500 hover:text-white"
            onClick={() =>
              window.open(
